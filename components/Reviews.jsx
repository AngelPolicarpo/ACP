  ...
  const reviewsData = [
    {
      ...
      image:
        "https://lh3.googleusercontent.com/a-/ALV-UjU9AB4LXVHYLRgcPd4z9g9ut3VskgaaUGcIN0o99zKbKoY7ZcH6UQ=w36-h36-p-rp-mo-br100",
    },
    {
      id: 2,
      name: "Maria Souza",
      ...
      image:
        "https://lh3.googleusercontent.com/a-/ALV-UjV7QfT7Q9gnPoT8Og4NMFfTf_PgE1OjEH5m-TquYfzAWRK7wfte=w36-h36-p-rp-mo-ba4-br100",
    },
  ...
  return (
    ...
    >
      {reviewsData.map((review) => (
        <div key={review.id} className={styles.reviewsContainer}>
          <div>
            <div>
              <img
                src={review.image}
